...
**Status:** **Mendy Small is drawn and in the game.** Everything else is still
a coloured rectangle, exactly as BOCHUR_BROS_DESIGN.md §9 asks ("Build with
placeholder rectangles first"). Art lands one form at a time and nothing about
the physics changes.
...
| | |
|---|---|
| Mendy | drawn — see `tools/art/generate.py` |
